...
import ResultsPreview, { ConfirmPreview, ProcessingPreview, PrimerPreview, PhotoPreview, PaywallPreview } from '@/dev/ResultsPreview';
...
export default function StudioPage() {
  ...
  const renderMainSurface = () => {
    ...
    if (import.meta.env.DEV && PREVIEW) {
      ...
      if (PREVIEW === 'photo') return <PhotoPreview />;
      if (PREVIEW === 'paywall') return <PaywallPreview />;
    }
